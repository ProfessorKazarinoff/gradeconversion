...
def main(wp='wp_download.csv', D2L='D2L_download.csv', output='output.csv'):
    ...
    parser.add_argument('WileyPlus_csv',
                        help="Browse to the WileyPlus file you downloaded",
                        widget='FileChooser')
    parser.add_argument('D2L_csv',
                        help="Browse to the D2L file you downloaded",
                        widget='FileChooser')
    parser.add_argument('output_dir',
                        help="Choose the output directory you want to dump your output .csv file into",
                        widget='DirChooser')
    parser.add_argument('output_csv',
                        help="Type name of output csv file, include .csv extension",
                        widget='TextField',)
    ...
    out_file_path = os.path.join(output_dir, output_csv)
