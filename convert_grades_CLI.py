...
if __name__ == "__main__":
	print('This is a command line tool to convert grades in WileyPlus to D2L')
	print('You will need to download the WileyPlus grades')
	print('You will need to download the blank D2L grades')
	WPcsv = input('Name of WileyPlus csv: ')
	D2Lcsv = input('Name of D2L csv: ')
	outputcvs = input('Name for the output file csv: ')
	main(WPcsv,D2Lcsv,outputcvs)